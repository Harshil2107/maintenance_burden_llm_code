"""
RQ3b: Regression Analysis — Does File Heat Explain Churn Differences?
...
Prerequisites:
  - RQ3/plotting_csv/pr_level_metrics_500st.csv  (churn metrics)
  - RQ3/file_heat_scores.csv                     (from file_heat_analysis.py)
  - RQ3/covariates.csv                            (from extract_covariates.py)
"""
...
def save_results(table_text, models, model_names):
    ...
    with open(report_path, "w") as f:
        f.write("# RQ3b: Regression Analysis Results\n\n")
